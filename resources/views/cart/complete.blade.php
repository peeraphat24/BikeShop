...
<table border="0" width="100%">
        ...
        <table border="0" width="100%">
            ...
            <tr><td><strong>อีเมล์:</strong></td> <td>{{$cust_email}}</td></tr>
        </table>
        </td>
        ...
        <tr>
            <td>
                ...
                <ul>
                    ...
                    <li>กรุณาชำระงเินภายใน 7 วัน หลังจากที่สั่งซื้อ</li>
                    <li>ชำระงเินแล้วส่งหลักฐานมาที่ sales@bikeshop.com หรือ LINE: @bikeshop</li>
                </ul>
            </td>
            <td align ="right"><strong>จำนวนเงินรวมทั้งสิ้น</strong><h1>{{$total_amount,2}} บาท</h1></td>
        </tr>
    </table>
</body>
</html>