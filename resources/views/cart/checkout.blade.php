...
<div class = "container">
    ...
    <li><a href="{{URL::to('cart/view')}}">สินค้าในตระกร้า</a></li>
    <li class = "active">ชำระเงิน</li>
    </div>
    
    <div class = "row">
        <div class = "col-md-6">
            <!--ข้อมูลสินค้าในตระกร้า-->
    ...
    <div class ="pull-right">
        ...
        <script>
            function complete(){
            window.open("{{URL::to('cart/complete')}}?cust_name="+$('#cust_name').val() + '&cust_email=' + $('#cust_email').val(),"_blank",);
